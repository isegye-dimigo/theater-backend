...
const commonSchema: Schema<'positiveInteger' | 'positiveFloat' | 'sha512Hex' | 'datetime' | 'jsonWebToken'> = new Schema<'positiveInteger' | 'positiveFloat' | 'sha512Hex' | 'datetime' | 'jsonWebToken'>({
